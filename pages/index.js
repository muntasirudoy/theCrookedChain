...
function Home({contact}) {
    ...
    return (
        <Layout modelRight={{children: <ModalContact/>, propsModal: {textBtn: "Contact"}}}>
            ...
            />
            <HeroSection data={contact} className="container section-margin container fill-right-container"
            ...
            <div className="container section-margin" data-dsn-title="Our Services">
                ...
                <ServiceTow data={getServiceData()}/>
            </div>
            {/*End Service*/}

            {/*Start Box Info Move Content*/}
            <div className="p-relative section-margin">
                <ParallaxImage src="/img/service.webp" overlay={2} alt={""}/>
                    ...
                    <div className="p-relative pt-lg-section">
                        <div className="box-info h-100 box-padding background-section ">
                            <DsnGrid className="box-info-inner" col={1} colGap={0}>
                                <TitleCover>Crooked Chain</TitleCover>
                                <TitleSection
