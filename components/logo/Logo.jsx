...
import brandDark from './logo.svg';
...
const Logo = ({width, height, alt}) => {
    ...
    return (
        <MainBrand className="main-brand" width={width} height={height}>
            <Image className="logo-light" src={brandLight?.src} alt={`${alt} - logo light`} width={320} height={100}/>
            <Image className="logo-dark" src={brandDark?.src} alt={`${alt} - logo dark`} width={320} height={100}/>
        </MainBrand>
    );
}
