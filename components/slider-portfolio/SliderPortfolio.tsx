...
function SliderPortfolio({
    ...
    return (
        ...
        <Tag
            className={dsnCN('main-slider half-content has-horizontal  background-main', fullWidth && "full-width", typeBg === "padding-image" ? "demo-1 v-dark-head-mobile" : typeBg === "half-image" ? "demo-2 v-dark-head-mobile" : typeBg + " v-dark-head", classNameSlider
            )}
            ref={rootSlider}>
